...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
  ...
  // Activation ops
  // NOTE: The following activation ops have been migrated to vllm._C_stable
  // using STABLE_TORCH_LIBRARY: silu_and_mul, mul_and_silu, gelu_and_mul,
  // gelu_tanh_and_mul, fatrelu_and_mul, swigluoai_and_mul, gelu_new,
  // gelu_fast, gelu_quick. See torch_bindings_stable.cpp.

  // Quantized activation ops (remain in _C as they use different
  // implementations)
  ops.def(
