...
void paged_attention_v2_launcher(
  ...
  float* exp_sums_ptr = exp_sums.mutable_data_ptr<float>();
  float* max_logits_ptr = max_logits.mutable_data_ptr<float>();
  T* tmp_out_ptr = reinterpret_cast<T*>(tmp_out.mutable_data_ptr());
