...
// Cuda utils library
STABLE_TORCH_LIBRARY(_C_cuda_utils, m) {
...
STABLE_TORCH_LIBRARY_IMPL(_C_cuda_utils, CompositeExplicitAutograd, m) {
  m.impl("get_device_attribute", TORCH_BOX(&get_device_attribute));
  m.impl("get_max_shared_memory_per_block_device_attribute",
