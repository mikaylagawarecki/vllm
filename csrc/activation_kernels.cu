...
// Activation kernels migrated to use PyTorch stable ABI
// Original used: <ATen/cuda/CUDAContext.h>, <torch/all.h>,
// <c10/cuda/CUDAGuard.h> Now uses: torch/csrc/stable headers and C-shim APIs
